 ...
 *
 * @author xu shiheng (2014-1-9上午10:57:08)
 */
@SuppressWarnings("rawtypes")
public class DESUtil {

    public static String defaultFirstKey = "JD";
    public static String defaultSecondKey = "";
    public static String defaultThirdKey = "";
     ...
     * @return
     */
    public String strEncDefault(String data) {
        return this.strEnc(data, defaultFirstKey, defaultSecondKey, defaultThirdKey);
    }
     ...
     * @return
     */
    public String strDecDefault(String data) {
        return this.strDec(data, defaultFirstKey, defaultSecondKey, defaultThirdKey);
    }

    public static void main(String[] args) {
        DESUtil ttt = new DESUtil();
        String data = "xushb19861217";
        String str = ttt.strEncDefault(data);
        String dec = ttt.strDecDefault("3E2BBF9B02C4B531B199ED01730E2AFD");
