...
(function () {
    ...
    function L(w) {
        ...
        b.a = new function () {
            ...
            n = 4 < c ? c : I;
            return{Na: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], o: function (a, b) {
